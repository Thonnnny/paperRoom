...
class ProductPage extends StatefulWidget {
  const ProductPage({required Key key}) : super(key: key);
  @override
  _ProductPageState createState() => _ProductPageState();
  static String route() => '/productPage';
}

class _ProductPageState extends State<ProductPage> {
  bool loadingData = true;
  List<Product> _cartItems = [];
  late List<Product> shopItems;
  @override
                                ...
                                GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return ProductItem(
                                        ...
                                        productImage:
                                            shopItems[index].mainImage,
                                        price: shopItems[index].price,
                                        title: shopItems[index].name,
                                        press: () {
                                          press(index);
                                        },
                                      );
